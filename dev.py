...
print 'bb', bb
print 'bb.start', bb.start
print 'bb.function', bb.function
...
print 'bb0.start', bb0.basic_block.start

#print bb0.read_written_registers()
#bb0.apply_ssa({})

#process_graph(graph, 0)

print graph.compute_predecessors()

highlight_predecessors(bv, 0x100000f2e)
